...
var _getallnames = require("./getallnames");
...
document.querySelector('#postMovie').addEventListener('click', async ()=>{
...
document.querySelector('#patchMovie').addEventListener('click', async ()=>{
...
(0, _getallnames.getAllNames)(base_url + '.json').then((names)=>{
    console.log(names);
...
},{"./getallnames":"9wKRt"}],"9wKRt":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getAllNames", ()=>getAllNames);
async function getAllNames(url) {
...
},{}]},["kmTUK","dMJ0o"], "dMJ0o", "parcelRequire94c2")
